...
for _ in range(num_entries):
    ...
    data.append([order_date, company_name, contact_name, order_status,order_no_string])
    ...
    for i in range(num_orders):
        ...
        order_company_name=company_name
        data.append([order_date, order_company_name, contact_name, order_status,order_no_string])
...
with open(csv_filename, mode='w', newline='') as file:
    ...
    writer.writerow(["order_date", "company_name", "contact_name", "order_status","order_no"])  # Write header row
